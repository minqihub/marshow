...
public class SendMail {  
    ...
    public static void main(String[] args) {  
        ...
        sendmail.setUserName("formsg");//您的邮箱用户名  
//        sendmail.setPassWord("ionbnxmxizlohfbi");//您的邮箱密码  
        sendmail.setPassWord("m7913753456");//您的邮箱密码  
        sendmail.setTo("minqi@qq.com");//接收者  
        sendmail.setFrom("formsg@qq.com");//发送者  
