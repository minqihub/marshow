...
//		        {fixed: 'right', width:150, align:'center', toolbar: '#barDemo'},
		        {fixed: 'right', width:450, align:'center', toolbar: '#barDemo'}
//		        {space: true, toolbar: '#barDemo'}
		]],
    	page: true,
    	height: 315,
    	even: true ,	//开启隔行背景
...
//	var checkStatus = table.checkStatus('test1'); //test即为参数id设定的值
